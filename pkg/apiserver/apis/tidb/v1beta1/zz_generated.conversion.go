...
// Convert_v1beta1_FooSpec_To_tidb_FooSpec is an autogenerated conversion function.
func Convert_v1beta1_FooSpec_To_tidb_FooSpec(in *FooSpec, out *tidb.FooSpec, s conversion.Scope) error {
	return autoConvert_v1beta1_FooSpec_To_tidb_FooSpec(in, out, s)
}
...
// Convert_tidb_FooSpec_To_v1beta1_FooSpec is an autogenerated conversion function.
func Convert_tidb_FooSpec_To_v1beta1_FooSpec(in *tidb.FooSpec, out *FooSpec, s conversion.Scope) error {
	return autoConvert_tidb_FooSpec_To_v1beta1_FooSpec(in, out, s)
}
