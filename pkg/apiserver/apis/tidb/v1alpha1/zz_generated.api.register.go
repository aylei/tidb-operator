...
var (
	ApiVersion = builders.NewApiVersion("tidb.pingcap.com", "v1alpha1").WithResources(
		tidb.TidbFooStorage,
		builders.NewApiResource( // Resource status endpoint
			tidb.InternalFooStatus,
			...
			&tidb.FooStatusStrategy{builders.StatusStorageStrategySingleton},
		))
