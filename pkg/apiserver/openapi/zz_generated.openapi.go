...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.Foo":          schema_apiserver_apis_tidb_v1alpha1_Foo(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.FooList":      schema_apiserver_apis_tidb_v1alpha1_FooList(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.FooSchemeFns": schema_apiserver_apis_tidb_v1alpha1_FooSchemeFns(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.FooSpec":      schema_apiserver_apis_tidb_v1alpha1_FooSpec(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.FooStatus":    schema_apiserver_apis_tidb_v1alpha1_FooStatus(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.Foo":           schema_apiserver_apis_tidb_v1beta1_Foo(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.FooList":       schema_apiserver_apis_tidb_v1beta1_FooList(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.FooSchemeFns":  schema_apiserver_apis_tidb_v1beta1_FooSchemeFns(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.FooSpec":       schema_apiserver_apis_tidb_v1beta1_FooSpec(ref),
		"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.FooStatus":     schema_apiserver_apis_tidb_v1beta1_FooStatus(ref),
...
func schema_apiserver_apis_tidb_v1alpha1_Foo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.FooSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.FooStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.FooSpec", "github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.FooStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_apiserver_apis_tidb_v1alpha1_FooList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.Foo"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1alpha1.Foo", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_apiserver_apis_tidb_v1alpha1_FooSchemeFns(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Foo Functions and Structs\n\nDeprecated",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"DefaultSchemeFns": {
						SchemaProps: spec.SchemaProps{
...
func schema_apiserver_apis_tidb_v1alpha1_FooSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_apiserver_apis_tidb_v1alpha1_FooStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_apiserver_apis_tidb_v1beta1_Foo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Foo",
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.FooSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.FooStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.FooSpec", "github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.FooStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_apiserver_apis_tidb_v1beta1_FooList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.Foo"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/pingcap/tidb-operator/pkg/apiserver/apis/tidb/v1beta1.Foo", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_apiserver_apis_tidb_v1beta1_FooSchemeFns(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Foo Functions and Structs\n\nDeprecated",
...
func schema_apiserver_apis_tidb_v1beta1_FooSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "FooSpec defines the desired state of Foo",
...
func schema_apiserver_apis_tidb_v1beta1_FooStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "FooStatus defines the observed state of Foo",
