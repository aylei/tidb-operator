...
import (
	...
	scheme "github.com/pingcap/tidb-operator/pkg/apiserver/client/clientset/internalversion/scheme"
...
type FooInterface interface {
	Create(*tidb.Foo) (*tidb.Foo, error)
	Update(*tidb.Foo) (*tidb.Foo, error)
	UpdateStatus(*tidb.Foo) (*tidb.Foo, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*tidb.Foo, error)
	List(opts v1.ListOptions) (*tidb.FooList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *tidb.Foo, err error)
	FooExpansion
}
...
func newFoos(c *TidbClient, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Get(name string, options v1.GetOptions) (result *tidb.Foo, err error) {
	result = &tidb.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(opts v1.ListOptions) (result *tidb.FooList, err error) {
	result = &tidb.FooList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Create(foo *tidb.Foo) (result *tidb.Foo, err error) {
	result = &tidb.Foo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(foo *tidb.Foo) (result *tidb.Foo, err error) {
	result = &tidb.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) UpdateStatus(foo *tidb.Foo) (result *tidb.Foo, err error) {
	result = &tidb.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *tidb.Foo, err error) {
	result = &tidb.Foo{}
