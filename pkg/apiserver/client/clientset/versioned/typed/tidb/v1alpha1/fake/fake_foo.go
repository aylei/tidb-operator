...
type FakeFoos struct {
	Fake *FakeTidbV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "tidb.pingcap.com", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "tidb.pingcap.com", Version: "v1alpha1", Kind: "Foo"}
