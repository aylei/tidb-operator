...
import (
	...
	v1beta1 "github.com/pingcap/tidb-operator/pkg/apiserver/client/listers/tidb/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TidbV1beta1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TidbV1beta1().Foos(namespace).Watch(options)
			},
		},
		&tidbv1beta1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tidbv1beta1.Foo{}, f.defaultInformer)
}
