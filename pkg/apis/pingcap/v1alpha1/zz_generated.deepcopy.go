...
func (in *TiKVConfig) DeepCopyInto(out *TiKVConfig) {
	*out = *in
	...
	if in.PessimisticTxn != nil {
		in, out := &in.PessimisticTxn, &out.PessimisticTxn
		*out = new(TiKVPessimisticTxnConfig)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TiKVPessimisticTxnConfig) DeepCopyInto(out *TiKVPessimisticTxnConfig) {
	*out = *in
	if in.Pipelined != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TiKVPessimisticTxnConfig.
func (in *TiKVPessimisticTxnConfig) DeepCopy() *TiKVPessimisticTxnConfig {
	if in == nil {
		return nil
	}
	out := new(TiKVPessimisticTxnConfig)
